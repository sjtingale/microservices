...
public class SwaggerConfig {
	  ...
	  public static final Contact DEFAULT_CONTACT = new Contact("Sujit", "sjt@gmail.com", "9856475216");
	  public static final ApiInfo DEFAULT = new ApiInfo("Nice Api Documentation", "Api Desc",
